...
```shell
GET /exapi/v1/withdraw/detail  (HMAC SHA256)
```
...
```shell
GET /exapi/v1/depositAddress  (HMAC SHA256)
```
...
```shell
GET /exapi/v1/withdrawalOrders  (HMAC SHA256)
```
